...
export class DashboardsService {
  ...
  getByScope(params: DashboardsApi.GetByScope.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.GetByScope.REQ_PATH, params);

    return this.http.get<DashboardsApi.GetByScope.Response>(path);
  }

  getBySerial(params: DashboardsApi.GetBySerial.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.GetBySerial.REQ_PATH, params);
  ...
  create(body: DashboardsApi.Create.Body) {
    const path = injectURLPayload(this.config.api + DashboardsApi.Create.REQ_PATH);
  ...
  update(params: DashboardsApi.Update.Params, body: DashboardsApi.Update.Body) {
    const path = injectURLPayload(this.config.api + DashboardsApi.Update.REQ_PATH, params);
  ...
  addSlide(params: DashboardsApi.AddSlide.Params, body: DashboardsApi.AddSlide.Body) {
    const path = injectURLPayload(this.config.api + DashboardsApi.AddSlide.REQ_PATH, params);
  ...
  updateSlidesOrder(params: DashboardsApi.UpdateSlidesOrder.Params, body: DashboardsApi.UpdateSlidesOrder.Body) {
    const path = injectURLPayload(this.config.api + DashboardsApi.UpdateSlidesOrder.REQ_PATH, params);
  ...
  updateSlide(params: DashboardsApi.UpdateSlide.Params, body: DashboardsApi.UpdateSlide.Body) {
    const path = injectURLPayload(this.config.api + DashboardsApi.UpdateSlide.REQ_PATH, params);

    return this.http.put<DashboardsApi.UpdateSlide.Response>(path, body);
  }

  removeSlide(params: DashboardsApi.RemoveSlide.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.RemoveSlide.REQ_PATH, params);
  ...
  addView(params: DashboardsApi.AddView.Params, body: DashboardsApi.AddView.Body) {
    const path = injectURLPayload(this.config.api + DashboardsApi.AddView.REQ_PATH, params);
  ...
  updateViewDataViz(params: DashboardsApi.UpdateViewDataViz.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.UpdateViewDataViz.REQ_PATH, params);
  ...
  updateViewsOrder(params: DashboardsApi.UpdateViewsOrder.Params, body: DashboardsApi.UpdateViewsOrder.Body) {
    const path = injectURLPayload(this.config.api + DashboardsApi.UpdateViewsOrder.REQ_PATH, params);
  ...
  updateView(params: DashboardsApi.UpdateView.Params, body: DashboardsApi.UpdateView.Body) {
    const path = injectURLPayload(this.config.api + DashboardsApi.UpdateView.REQ_PATH, params);

    return this.http.put<DashboardsApi.UpdateView.Response>(path, body);
  }

  removeView(params: DashboardsApi.RemoveView.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.RemoveView.REQ_PATH, params);
  ...
  addAccessOrgunit(params: DashboardsApi.AddAccessOrgunit.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.AddAccessOrgunit.path, params);
  ...
  removeAccessOrgunit(params: DashboardsApi.RemoveAccessOrgunit.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.RemoveAccessOrgunit.path, params);
  ...
  addAccessUser(params: DashboardsApi.AddAccessUser.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.AddAccessUser.path, params);
  ...
  removeAccessUser(params: DashboardsApi.RemoveAccessUser.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.RemoveAccessUser.path, params);
  ...
  addAccessGroup(params: DashboardsApi.AddAccessGroup.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.AddAccessGroup.path, params);
  ...
  removeAccessGroup(params: DashboardsApi.RemoveAccessGroup.Params) {
    const path = injectURLPayload(this.config.api + DashboardsApi.RemoveAccessGroup.path, params);
