...
export class ReportsService {
  ...
  getByScope(params: ReportsApi.GetByScope.Params) {
    const path = injectURLPayload(this.config.api + ReportsApi.GetByScope.REQ_PATH, params);

    return this.http.get<ReportsApi.GetByScope.Response>(path);
  }

  getBySerial(params: ReportsApi.GetBySerial.Params) {
    const path = injectURLPayload(this.config.api + ReportsApi.GetBySerial.REQ_PATH, params);
  ...
  create(body: ReportsApi.Create.Body) {
    const path = injectURLPayload(this.config.api + ReportsApi.Create.REQ_PATH);
  ...
  update(params: ReportsApi.Update.Params, body: ReportsApi.Update.Body) {
    const path = injectURLPayload(this.config.api + ReportsApi.Update.REQ_PATH, params);
  ...
  addSlide(params: ReportsApi.AddSlide.Params, body: ReportsApi.AddSlide.Body) {
    const path = injectURLPayload(this.config.api + ReportsApi.AddSlide.REQ_PATH, params);
  ...
  updateSlidesOrder(params: ReportsApi.UpdateSlidesOrder.Params, body: ReportsApi.UpdateSlidesOrder.Body) {
    const path = injectURLPayload(this.config.api + ReportsApi.UpdateSlidesOrder.REQ_PATH, params);
  ...
  updateSlide(params: ReportsApi.UpdateSlide.Params, body: ReportsApi.UpdateSlide.Body) {
    const path = injectURLPayload(this.config.api + ReportsApi.UpdateSlide.REQ_PATH, params);

    return this.http.put<ReportsApi.UpdateSlide.Response>(path, body);
  }

  removeSlide(params: ReportsApi.RemoveSlide.Params) {
    const path = injectURLPayload(this.config.api + ReportsApi.RemoveSlide.REQ_PATH, params);
  ...
  addView(params: ReportsApi.AddView.Params, body: ReportsApi.AddView.Body) {
    const path = injectURLPayload(this.config.api + ReportsApi.AddView.REQ_PATH, params);
  ...
  updateViewContent(params: ReportsApi.UpdateViewContent.Params, body: ReportsApi.UpdateViewContent.Body) {
    const path = injectURLPayload(this.config.api + ReportsApi.UpdateViewContent.REQ_PATH, params);
  ...
  updateViewImage(params: ReportsApi.UpdateViewContentImage.Params, body: ReportsApi.UpdateViewContentImage.Body) {
    const path = injectURLPayload(this.config.api + ReportsApi.UpdateViewContentImage.REQ_PATH, params);
  ...
  updateViewsOrder(params: ReportsApi.UpdateViewsOrder.Params, body: ReportsApi.UpdateViewsOrder.Body) {
    const path = injectURLPayload(this.config.api + ReportsApi.UpdateViewsOrder.REQ_PATH, params);
  ...
  updateView(params: ReportsApi.UpdateView.Params, body: ReportsApi.UpdateView.Body) {
    const path = injectURLPayload(this.config.api + ReportsApi.UpdateView.REQ_PATH, params);

    return this.http.put<ReportsApi.UpdateView.Response>(path, body);
  }

  removeView(params: ReportsApi.RemoveView.Params) {
    const path = injectURLPayload(this.config.api + ReportsApi.RemoveView.REQ_PATH, params);
  ...
  addAccessOrgunit(params: ReportsApi.AddAccessOrgunit.Params) {
    const path = injectURLPayload(this.config.api + ReportsApi.AddAccessOrgunit.path, params);
  ...
  removeAccessOrgunit(params: ReportsApi.RemoveAccessOrgunit.Params) {
    const path = injectURLPayload(this.config.api + ReportsApi.RemoveAccessOrgunit.path, params);
  ...
  addAccessUser(params: ReportsApi.AddAccessUser.Params) {
    const path = injectURLPayload(this.config.api + ReportsApi.AddAccessUser.path, params);
  ...
  removeAccessUser(params: ReportsApi.RemoveAccessUser.Params) {
    const path = injectURLPayload(this.config.api + ReportsApi.RemoveAccessUser.path, params);
  ...
  addAccessGroup(params: ReportsApi.AddAccessGroup.Params) {
    const path = injectURLPayload(this.config.api + ReportsApi.AddAccessGroup.path, params);
  ...
  removeAccessGroup(params: ReportsApi.RemoveAccessGroup.Params) {
    const path = injectURLPayload(this.config.api + ReportsApi.RemoveAccessGroup.path, params);
